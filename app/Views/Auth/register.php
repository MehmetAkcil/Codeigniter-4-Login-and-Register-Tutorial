        ...
        <div class="col-md-4 mx-auto bg-light p-3 rounded-3 border shadow-sm">
            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="name surname" value="<?= set_value('name') ?>" required>
                    <span class="text-danger"><?= session()->has('validator') ? error_function(session()->validator, 'name') : null ?></span>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">
                        Email Adresi
                    </label>
                    <input type="email" class="form-control" name="email" id="email" placeholder="name@example.com" value="<?= set_value('email') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <span class="text-danger"><?= session()->has('validator') ? error_function(session()->validator, 'repassword') : null ?></span>
                </div>
                <div class="mb-3">
                    <?= csrf_field() ?>
                ...
                <div class="mb-3 text-center">
                    Hesabiniz var mi? <a href="<?= base_url('auth/login') ?>">Giris Yap</a>
                </div>
            </form>
        </div>
    </div>
